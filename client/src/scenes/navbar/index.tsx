        ...
        <div className="flex justify-between items-center py-4 w-full">
            ...
            <div className="flex justify-between text-sm items-center gap-4">
                <div className="hidden sm:flex items-center text-neutral-dark gap-3">
                    <ThemeToggle />
                    <BiSolidMessageDetail className="bg-bkg-default hover:bg-neutral-light p-1.5 lg:p-1 rounded-full transition cursor-pointer" size={32}/>
                    <IoMdNotifications className="bg-bkg-default hover:bg-neutral-light p-1.5 lg:p-1 rounded-full transition cursor-pointer" size={32}/>
                    <AiFillQuestionCircle className="bg-bkg-default hover:bg-neutral-light p-1.5 lg:p-1 rounded-full transition cursor-pointer" size={32}/>
                </div>
                <DropDown
